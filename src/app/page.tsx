      ...
      <section className="relative h-[600px] lg:h-[700px] mt-20">
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center px-6">
            ...
            <Link
              href="/book"
              className="inline-block px-10 py-4 bg-[hsl(var(--gold))] gold-button-text font-bold text-sm uppercase tracking-wide rounded hover:bg-[hsl(var(--light-gold))] transition-all shadow-button hover:scale-105"
            >
              Book Appointment
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link
                href="/about"
                className="inline-block px-8 py-3 bg-transparent border-2 border-[hsl(var(--gold))] text-gold font-semibold text-sm uppercase tracking-wide rounded hover:bg-[hsl(var(--gold))] hover:gold-button-text transition-all"
              >
                Learn More
              </Link>
            </div>
      ...
      <section className="py-20 px-6 lg:px-12 bg-[hsl(var(--background))]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/book"
              className="px-10 py-4 bg-[hsl(var(--gold))] gold-button-text font-bold text-sm uppercase tracking-wide rounded hover:bg-[hsl(var(--light-gold))] transition-all shadow-button"
            >
              Book Appointment
            </Link>
            <Link
              href="/contact"
              className="px-10 py-4 bg-transparent border-2 border-[hsl(var(--gold))] text-gold font-semibold text-sm uppercase tracking-wide rounded hover:bg-[hsl(var(--gold))] hover:gold-button-text transition-all"
            >
              Contact Us
            </Link>
          </div>
