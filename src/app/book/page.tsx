    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 px-6 lg:px-12 bg-[hsl(var(--background))]">
        <div className="max-w-5xl mx-auto">
          {submitted && (
            <div className="mb-8 p-6 bg-[hsl(var(--gold))] text-black rounded-lg text-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="text-center pt-6">
              <button
                ...
                className="px-12 py-4 bg-[hsl(var(--gold))] text-black font-bold text-sm uppercase tracking-wide rounded hover:bg-[hsl(var(--light-gold))] transition-all shadow-button disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Confirm Appointment
              </button>
      ...
      <section className="py-16 px-6 lg:px-12 bg-[hsl(var(--charcoal))]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            href="tel:2815558289"
            className="inline-block px-10 py-4 bg-transparent border-2 border-[hsl(var(--gold))] text-gold font-semibold text-sm uppercase tracking-wide rounded hover:bg-[hsl(var(--gold))] hover:text-black transition-all"
          >
            Call (281) 555-KUTZ
          </a>
        </div>
