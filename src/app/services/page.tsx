    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 px-6 lg:px-12 bg-[hsl(var(--charcoal))]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            href="/book"
            className="inline-block px-12 py-4 bg-[hsl(var(--gold))] text-black font-bold text-sm uppercase tracking-wide rounded hover:bg-[hsl(var(--light-gold))] transition-all shadow-button hover:scale-105"
          >
            Book Appointment
          </Link>
        </div>
